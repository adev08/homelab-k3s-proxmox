...
help: 
	...
	@echo ""
	@echo " make setup        - Run intial setup and check prerequisites"
    ...
    clean:
		...
		rm -rf .terraform .terraform.lock.hcl terraform.tfstate* *.logs
	
	status:
		@echo "Cluster Status"
		@export KUBECONFIG=$(shell pwd)/kubeconfig && kubectl get nodes -o wide
		@echo ""
		@export KUBECONFIG=$(shell pwd)/kubeconfig && kubectl get pods -Ansible
	...
	ping: 
		...
		@ping -c 192.168.1.180 > /dev/null && echo " Control plane (192.168.1.180)" || echo " Control plane unreachable"
		@echo "Pinging workers..."
		@ping -c 192.168.1.185 > /dev/null && echo " Worker 1 (192.168.1.185)" || echo " Worker 1 unreachable"
		@ping -c 192.168.1.186 > /dev/null && echo " Worker 2 (192.168.1.186)" || echo " Worker 2 unreachable"
		@ping -c 192.168.1.187 > /dev/null && echo " Worker 3 (192.168.1.187)" || echo " Worker 3 unreachable"
